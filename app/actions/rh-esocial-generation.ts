...
async function persist(input:{
  ...
  if(error)throw new Error(mensagemDeFalha("rh-esocial-generation.persist", error));
  return String(data);
}
...
export async function generateSignedEsocialTableEvent(data:FormData){
  ...
  try{
    if(eventType==="S-1000"){
      ...
      if(error||!profile)throw new Error(mensagemDeFalha("rh-esocial-generation.generateSignedEsocialTableEvent", error, "Perfil eSocial do empregador não encontrado."));
      ...
      if(eError||!employer)throw new Error(mensagemDeFalha("rh-esocial-generation.generateSignedEsocialTableEvent", eError, "Empregador não encontrado."));
      ...
      if(error||!profile)throw new Error(mensagemDeFalha("rh-esocial-generation.generateSignedEsocialTableEvent", error, "Perfil eSocial do estabelecimento não encontrado."));
      ...
      if(sError||!est)throw new Error(mensagemDeFalha("rh-esocial-generation.generateSignedEsocialTableEvent", sError, "Estabelecimento não encontrado."));
      ...
      if(vError||!version)throw new Error(mensagemDeFalha("rh-esocial-generation.generateSignedEsocialTableEvent", vError, "Versão da rubrica não encontrada."));if(eError||!employer)throw new Error(mensagemDeFalha("rh-esocial-generation.generateSignedEsocialTableEvent", eError, "Empregador não encontrado."));
      ...
      if(rError||!rubric)throw new Error(mensagemDeFalha("rh-esocial-generation.generateSignedEsocialTableEvent", rError, "Rubrica não encontrada."));
      ...
      if(error||!profile)throw new Error(mensagemDeFalha("rh-esocial-generation.generateSignedEsocialTableEvent", error, "Perfil eSocial da lotação não encontrado."));
      ...
      if(aError||!allocation)throw new Error(mensagemDeFalha("rh-esocial-generation.generateSignedEsocialTableEvent", aError, "Lotação tributária não encontrada."));
  ...
  }catch(error){fail(path,error instanceof Error?mensagemDeFalha("rh-esocial-generation.generateSignedEsocialTableEvent", error):"Falha ao gerar evento eSocial.");}
