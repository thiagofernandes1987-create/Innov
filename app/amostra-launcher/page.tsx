...
export default async function Amostra({ searchParams }: { searchParams: Promise<{ perfil?: string; cenario?: string }> }) {
  ...
  const operacionais = cenario === "problema"
    ? [
        ...
        { id: "demo-operacional-2", eventoId: "demo-evento-2", titulo: "Material crítico sem confirmação", corpo: "O fornecedor não confirmou o marco de expedição. Verifique a alternativa e o custo total da parada.", modulo: "compras", moduloNome: "Compras e Suprimentos", href: "#compras", persona: "P9" as const, prazoResposta: "2026-07-29T10:00:00.000Z", escalada: false, nova: true, criadaEm: "2026-07-28T12:20:00.000Z" }
      ]
    : [];
