...
- [ ] T-37.13b — **Importação manual com evidência**, o caminho que vale para os 27 hoje: UF, data-base, tipologia e valores, com o arquivo publicado pelo Sinduscon anexado, URL e SHA-256. Precisa passar por RPC `SECURITY DEFINER` — desde a T-37.12 a referência oficial é imutável para `authenticated`, e é assim que deve continuar
