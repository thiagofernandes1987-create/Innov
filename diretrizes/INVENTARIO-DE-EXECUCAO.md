...
- [ ] T-37.10 — Tela da composição analítica: hoje o catálogo importa e **nada o exibe**. É ela que precisa mostrar a composição incompleta em vez de barata, com o motivo por item. O dado já existe; falta a tela — e ela entra pelas quatro perguntas de `PERSONAS-E-ROTINAS.md`
