...
- **TypeScript:** nenhum portão novo. `pnpm lint`, `typecheck`, `test` e os 50 validadores já cobrem o diretório;
...
Segunda linguagem custa em três lugares — quem escreve, quem revisa e quem é acordado às 3 h. Hoje a plataforma é mantida por sessões assistidas sobre um repositório em TypeScript, com as diretrizes, as vacinas e os 50 validadores todos escritos para ele.
