...
returns table(line_id uuid,rubric_code text,rubric_name text,payroll_kind text,quantity numeric,reference_value numeric,amount numeric,calculation_trace jsonb)
...
declare v_wr uuid;begin
 ...
 return query select ln.id,r.code,r.name,r.payroll_kind,ln.quantity,ln.unit_value,ln.amount,ln.trace
