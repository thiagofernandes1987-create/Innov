...
revoke select(reference_unit_cost) on public.inventory_items from authenticated;
...
revoke select(unit_cost,total_cost) on public.inventory_movement_lines from authenticated;
...
revoke select(acquisition_cost) on public.inventory_assets from authenticated;
...
revoke select(cost) on public.inventory_asset_maintenance from authenticated;
