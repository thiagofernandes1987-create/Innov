...
const database = "innov_messaging_w17_security";
const environment = {
  ...process.env,
...
try {
  ...
  for (const file of [
    ...
    "supabase/migrations/20260804220000_stage22_security_hardening.sql",
    "supabase/tests/messaging-security/security.test.sql"
