...
if(!errors.length){
 ...
 for(const token of["fluxo unificado","correlation_id","append-only","RLS","alertas","health checks","diagnósticos","Definition of Done","seis migrations","zero FK sem índice","diagnósticos globais"])
...
console.log(`Etapa 19 validada: ${migrations.length} migrations alinhadas ao ledger, 6 tabelas com RLS, fluxo unificado, alertas, saúde, diagnósticos protegidos, zero FK sem índice e ${appFiles.length} arquivos de aplicação/documentação.`);
