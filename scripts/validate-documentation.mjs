...
if(errors.length===0){
 ...
 for(const file of [...requiredCanonical,"docs/ETAPA-17-ESTOQUE-INVENTARIO-ALMOXARIFADO.md","docs/RELATORIO-HOMOLOGACAO-ETAPA-17.md","docs/ETAPA-21-WMS-AVANCADO-AUTOMACAO-LOGISTICA.md"]){
