...
export const MODULE_REGISTRY: readonly ModuleManifest[] = [
  ...
  { key:"rh", name:"Recursos Humanos e DP", description:"Empregados, admissão, jornada, folha, SST e obrigações digitais.", icon:"♟", category:"Recursos Humanos", routePrefix:"/app/rh", sortOrder:175, dependencies:["documentos","financeiro"] },
  ...
  { key:"whatsapp", name:"WhatsApp e Atendimento", description:"Conversas oficiais ligadas a CRM, clientes, obras, contratos, SAC, modelos e documentos.", icon:"◍", category:"Atendimento", routePrefix:"/app/whatsapp", sortOrder:185, dependencies:["clientes","crm","sac","documentos"] },
  { key:"relatorios", name:"Relatórios e Indicadores", description:"Painéis executivos, metas, snapshots e exportações autorizadas.", icon:"▥", category:"Geral", routePrefix:"/app/relatorios", sortOrder:190, dependencies:["obras"] },
